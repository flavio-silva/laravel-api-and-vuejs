    ...
    <div class="w-96 bg-blue-900 rounded-lg shadow-xl p-6">
        ...
        <form method="POST" action="{{ route('login') }}" class="pt-8">
            ...
            <div class="relative pt-3">
                <label for="password" class="uppercase absolute text-blue-500 text-xs font-bold pt-2 pl-2">Password</label>

                <div>
                    <input id="password" type="password" class="w-full rounded pt-8 p-3 text-gray-100 bg-blue-800 focus:bg-blue-700 outline-none" name="password" autocomplete="current-password">
            ...
            <div class="pt-8">
                <button type="submit" class="w-full bg-gray-400 py-2 px-3 text-left rounded uppercase text-blue-300 font-bold">
                    {{ __('Login') }}
                </button>
            </div>
