...
<div class="flex justify-center items-center h-full bg-gray-300">
    ...
    <div class="bg-blue-900 rounded w-96 p-6">
        ...
        <h1 class="text-white mt-8 text-3xl">Oh no!</h1>
        ...
        <form method="POST" action="{{ route('password.email') }}" class="mt-8">
            ...
            <div class="relative">
                ...
                <div>
                    <input id="email" type="email"
                           class="bg-blue-800 text-gray-100 w-full outline-none pt-8 p-3 rounded focus:bg-blue-700"
            ...
            <button type="submit" class="w-full text-left bg-gray-400 px-3 py-2 mt-8 text-blue-800 rounded uppercase font-bold text-sm">
                Send Reset Email
            </button>
        </form>

        <div class="flex justify-between text-white font-bold mt-8">
